...
from keras.layers import UpSampling1D,Add,Masking,Merge,Flatten,Concatenate,LeakyReLU,PReLU,Input,LSTM, core, Bidirectional, CuDNNLSTM, CuDNNGRU,Reshape,Lambda,Permute,TimeDistributed,RepeatVector,ConvLSTM2D,Conv3D,Dense,UpSampling3D,Embedding, SpatialDropout1D,GRU,Add,Activation,multiply
...
#### IGLOO_RETURNFULLSEQ
#################################################################################
def IGLOO_RETURNFULLSEQ(input_layer,nb_patches,nb_filters_conv1d,patch_size=4,padding_style="causal",stretch_factor=1,nb_stacks=1,l2reg=0.00001,conv1d_kernel=3,DR=0.0,add_residual=True,nb_sequences=-1,build_backbone=False,psy=0.15):
